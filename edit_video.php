                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">                       
                      <select name="premium" id="premium" style="width:280px; height:25px;" class="select2" required>
                            ...
                            <option value="Y" <?php if($row['premium']=='Y'){?>selected<?php }?>>Yes</option>
                            <option value="N" <?php if($row['premium']=='N'){?>selected<?php }?>>No</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div id="thumbnail" class="form-group" <?php if($row['video_type']=='server_url' or $row['video_type']=='local'){?>style="display:block;"<?php }else{?>style="display:none;"<?php }?>>
                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        ...
                        <input style="form-group" type="file" name="video_thumbnail" value="" id="fileupload">
                        <div class="fileupload_img">
                            <img src="http://www.pngmart.com/files/3/Upload-Button-PNG-File.png" alt="edit video image" height="20px" width="90px" />
                            <label for="imageInput">Click Here to Change</label>
                            </div>
