            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                   ...
                   <td><a href="add_user.php?user_id=<?php echo $users_row['id'];?>" class="btn btn-primary btn-round"><i class="fa fa-edit"></i></a>
                    <a href="manage_users.php?user_id=<?php echo $users_row['id'];?>" onclick="return confirm('Are you sure you want to delete this user?');" class="btn btn-default btn-round"><i class="fa fa-trash"></i></a></td>
                </tr>
               <?php
